...
public class CheckoutPage {
	...
	private By botaoConfirmarPedido =By.cssSelector("#payment-confirmation button");
	...
	public void selecionarRadioPlayByCheck() {
	...
	public PedidoPage clicaBotaoConfirmaPedido() {
